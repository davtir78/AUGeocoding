...
const cors_1 = __importDefault(require("cors")); // Import the cors package as default
...
const corsHandler = (0, cors_1.default)({ origin: true }); // Configure CORS to allow all origins for now
